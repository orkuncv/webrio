<?php
/**
 * Title: Header stacked search
 * Slug: nova/header-stacked-search
 * Categories: header
 * Description: A stacked header with a logo, CTA on the top row, and navigation and search on the bottom row.
 *
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}},"backgroundColor":"white","className":"nova-header-stacked"},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull nova-header-stacked has-white-background-color has-background" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);">
    ...
    <div class="wp-block-group alignwide nova-header-stacked__top">
        ...
        <div class="wp-block-group is-vertically-aligned-center">
            ...
            <!-- wp:buttons -->
            <div class="wp-block-buttons nova-header__buttons">
                <!-- wp:button {"backgroundColor":"nova-100","textColor":"white"} -->
                <div class="wp-block-button"><a class="wp-block-button__link has-white-color has-nova-100-background-color has-text-color has-background wp-element-button"><?php echo esc_html_x( 'Button Label', 'Header CTA button', 'nova' ); ?></a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
    ...
    <!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|20"}}},"className":"nova-header-stacked__bottom","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
