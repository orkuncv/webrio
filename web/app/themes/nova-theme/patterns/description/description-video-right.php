<?php
/**
 * Title: Description, YouTube right
 * Slug: nova/description-video-right
 * Categories: description
 * Description: A two-column layout with text and buttons on the left and a YouTube video on the right.
 *
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-top">
        ...
        <!-- wp:column {"width":"58%","verticalAlignment":"top", "style":{"spacing":{"blockGap":"2rem"}}} -->
        ...
        <div class="wp-block-column is-vertically-aligned-top">
            ...
            <!-- wp:embed {"url":"https://www.youtube.com/watch?v=example","type":"video","providerNameSlug":"youtube","responsive":true,"className":"wp-embed-aspect-16-9 wp-has-aspect-ratio"} -->
