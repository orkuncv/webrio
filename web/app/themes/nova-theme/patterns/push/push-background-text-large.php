<?php
/**
 * Title: Push, background text large (Large)
 * Slug: nova/push-background-text-large
 * Categories: push
 * Description: A full-width, prominent, centered text block with a background color and call-to-action buttons.
 *
...
<!-- wp:group {"align":"full","backgroundColor":"nova-100","textColor":"white","style":{"spacing":{"blockGap":"2rem","padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-white-color has-nova-100-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50)">
    ...
    <h2 class="wp-block-heading has-text-align-center has-xl-heading-font-size"><?php echo esc_html_x( 'This is a headline for the title part', 'Push section heading', 'nova' ); ?></h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","fontSize":"p-huge"} -->
    <p class="has-text-align-center has-p-huge-font-size"><?php echo esc_html_x( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Scelerisque pellentesque pharetra quam enim porttitor.', 'Push section description', 'nova' ); ?></p>
    <!-- /wp:paragraph -->
