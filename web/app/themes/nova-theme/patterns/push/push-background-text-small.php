<?php
/**
 * Title: Push, background text (small)
 * Slug: nova/push-background-text-small
 * Categories: push
 * Description: A standard-width, prominent, centered text block with a background color and call-to-action buttons.
 *
...
<!-- wp:group {"backgroundColor":"nova-100","textColor":"white","style":{"spacing":{"blockGap":"2rem","padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group has-white-color has-nova-100-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50)">
