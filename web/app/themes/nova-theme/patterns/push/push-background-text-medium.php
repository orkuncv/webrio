<?php
/**
 * Title: Push, background text (medium)
 * Slug: nova/push-background-text-medium
 * Categories: push
 * Description: A prominent, centered text block with a background color and call-to-action buttons. The width can be adjusted (default, wide, full).
 *
...
<!-- wp:group {"align":"wide","backgroundColor":"nova-100","textColor":"white","style":{"spacing":{"blockGap":"2rem","padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide has-white-color has-nova-100-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50)">
	...
	<!-- wp:heading {"textAlign":"center","level":2,"fontSize":"l-heading"} -->
	<h2 class="wp-block-heading has-text-align-center has-l-heading-font-size"><?php echo esc_html_x( 'This is a headline for the title part', 'Push section heading', 'nova' ); ?></h2>
	<!-- /wp:heading -->
