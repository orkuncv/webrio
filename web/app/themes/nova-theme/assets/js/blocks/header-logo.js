...
(function (wp) {
    ...
    // --- Register Header Logo Block ---
    registerBlockType('nova/header-logo', {
        title: __('Header Logo', 'nova'),
        description: __('Displays the site logo in the header.', 'nova'),
        category: 'nova',
        icon: blockIcon,
        keywords: [__('logo', 'nova'), __('header', 'nova'), __('brand', 'nova')],
        attributes: {}, // No client-side attributes needed
        ...
        edit: function (props) {
            ...
            return el(
                ...
                blockProps,
                el(ServerSideRender, {
                    block: 'nova/header-logo',
                    attributes: props.attributes,
                    EmptyResponsePlaceholder: function () {
                        return el('p', {style: {fontStyle: 'italic', color: '#777'}},
                            __('Header Logo preview. Set the logo in Appearance > Customize > Site Identity.', 'nova')
                        );
                    },
                })
            );
