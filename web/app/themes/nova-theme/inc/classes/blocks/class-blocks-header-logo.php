<?php
/**
 * Registers Custom Gutenberg Block: Header Logo
 *
...
if ( ! class_exists( 'Nova_Blocks_Header_Logo' ) ) :

	class Nova_Blocks_Header_Logo implements Nova_Contracts_Gutenberg_Block {
		...
		public function register_block(): void {
			...
			register_block_type( 'nova/header-logo', [
				'api_version'     => 2,
				'category'        => 'nova',
				'editor_script'   => 'nova-header-logo-editor',
				'render_callback' => [ $this, 'render_block' ],
				'attributes'      => [],
				'title'           => __( 'Header Logo', 'nova' ),
				'description'     => __( 'Displays the site logo in the header.', 'nova' ),
				'icon'            => 'format-image',
			] );
		}
		...
		public function block_assets(): array {
			return [
				'path' => get_template_directory() . '/assets/js/blocks/header-logo.js',
				'url'  => get_template_directory_uri() . '/assets/js/blocks/header-logo.js',
			];
		}
		...
		public function render_block( array $attributes, string $content, ?WP_Block $block = null ): string {
			...
			$logo_url = get_option( 'nova_theme_header_logo', '' );
